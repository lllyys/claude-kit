---
description: "Recreate the 4 session-only crons (verify, bugfix, watchdog, feature) from `${CLAUDE_PLUGIN_ROOT}/cron-prompts/`. Use after a Claude Code restart since the `durable` flag isn't honored by this runtime."
---
