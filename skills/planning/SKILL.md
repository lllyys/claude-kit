...
- Good: “Submitting the form with an empty required field shows a validation error and blocks submission (test asserts on the error state and that no request is sent).”
- Bad: “The form handles bad input better.”
