...
3) **Run gates**
   - Run the project's test command (see `.claude/tdd-guardian/config.json` → `testCommand`) and any gates the plan's “Testing Procedures” section lists; use the project's build/gate command for the full quality gate.
