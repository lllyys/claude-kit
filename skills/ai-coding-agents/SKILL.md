...
**Note:** This skill documents both tools for reference. This toolkit's workflows primarily drive **Claude Code CLI**, with **Codex CLI** used as an independent cross-model reviewer/auditor. Both sections are retained for completeness and cross-tool workflows.
